...
type validatorPool struct {
	...
	prevValidators    *cbfttypes.Validators
	currentValidators *cbfttypes.Validators
}

func newValidatorPool(agency Agency, blockNumber uint64, nodeID discover.NodeID) *validatorPool {
	pool := &validatorPool{
		agency: agency,
		nodeID: nodeID,
	}
